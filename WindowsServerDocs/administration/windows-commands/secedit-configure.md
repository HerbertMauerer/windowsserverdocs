...
**Note**: SECEDIT may write the registry keys and values in the INF file to the regstry in lowercase. This is not a problem as both registry keys and values are not case sensitive.
